...
while [[ $# -gt 0 ]]; do
  case "$1" in
    -d|--dataset)
      ...
      ;;
    -h|--help)
      echo "Usage: $0 [-d|--dataset <tvr|activitynet>]"
      exit 0
      ;;
    *)
...
COARSE_FF_DIM=${COARSE_FF_DIM:-1024}
...
case "${DATASET}" in
  tvr)
    DEFAULT_H5_PATH="/dev/ssd1/gjw/prvr/cache/frame_embeds_3fps.h5"
    DEFAULT_NPY_DIR="/dev/ssd1/gjw/vcmr/TOT-CVPR22/tvr_dataset/features"
    DEFAULT_TRAIN_JSONL_PATHS="/dev/ssd1/gjw/prvr/dataset/tvr/TextData/tvr_train_release.jsonl,/dev/ssd1/gjw/prvr/dataset/tvr/TextData/tvr_val_release.jsonl"
    DEFAULT_INFER_JSONL_PATHS="/dev/ssd1/gjw/prvr/dataset/tvr/TextData/tvr_train_release.jsonl,/dev/ssd1/gjw/prvr/dataset/tvr/TextData/tvr_val_release.jsonl"
    DEFAULT_INFER_OUTPUT_JSONS="./output/boundaries_tvr_train.${OUTPUT_FORMAT},./output/boundaries_tvr_val.${OUTPUT_FORMAT}"
    DEFAULT_MERGE_TRAIN_VAL=1
    ;;
  act|activitynet|act_frames)
    DEFAULT_H5_PATH="./output/activitynet_frame_embeds.h5"
    DEFAULT_NPY_DIR="/dev/hdd2/gjw/datasets/activitynet/features"
    DEFAULT_TRAIN_JSONL_PATHS="/dev/hdd2/gjw/datasets/activitynet/activitynet_train.jsonl,/dev/hdd2/gjw/datasets/activitynet/activitynet_val.jsonl"
    DEFAULT_INFER_JSONL_PATHS="/dev/hdd2/gjw/datasets/activitynet/activitynet_train.jsonl,/dev/hdd2/gjw/datasets/activitynet/activitynet_val.jsonl"
    DEFAULT_INFER_OUTPUT_JSONS="./output/boundaries_act_train.${OUTPUT_FORMAT},./output/boundaries_act_val.${OUTPUT_FORMAT}"
    DEFAULT_MERGE_TRAIN_VAL=1
    ;;
  *)
