...
cfg['dataset_name'] = 'msrvtt'
cfg['seed'] = 9527
cfg['root'] = '/home/jaewoo/GMMFormer'
cfg['data_root'] = '/home/jaewoo/'
cfg['msrvtt_video_dir'] = '/home/jaewoo/msr-vtt/MSRVTT_Videos'  # Raw 비디오 경로

cfg['visual_feature'] = 'clip'  # MSRVTT uses CLIP features
cfg['visual_feat_dim'] = 512  # CLIP ViT-B/32 feature dimension
cfg['collection'] = 'msrvtt'
cfg['map_size'] = 32
