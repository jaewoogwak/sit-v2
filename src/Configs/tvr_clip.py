...
cfg['wd'] = 0.01
cfg['margin'] = 0.1  # TVR은 margin 0.1 사용
...
# model - CLIP 피쳐에 맞게 조정
cfg['max_desc_l'] = 30
cfg['max_ctx_l'] = 128
cfg['q_feat_size'] = 512  # CLIP 텍스트 피쳐 차원 (RoBERTa 1024 -> CLIP 512)
