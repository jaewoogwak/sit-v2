...
# rsync -avh -progress -z -e "ssh" jaewoo@100.124.18.45:/home/jaewoo/GMMFormer 
...
# eval
cfg['eval_query_bsz'] = 50   # Process 1 query at a time
cfg['eval_context_bsz'] = 100  # Reduced batch size for memory safety
