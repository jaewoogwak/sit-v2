...
cfg['model_name'] = 'gmmformer-hd'
cfg['dataset_name'] = 'tvr'
cfg['seed'] = 9527
cfg['root'] = '/disk/gjw/GMMFormer'
cfg['data_root'] = '/disk/gjw/'

cfg['visual_feature'] = 'i3d_resnet'
cfg['visual_feat_dim'] = 2048  # I3D + ResNet feature dimension
cfg['collection'] = 'tvr'
cfg['map_size'] = 32
cfg['clip_scale_w'] = 1  # Not used in HD model, but kept for compatibility
cfg['frame_scale_w'] = 0
...
cfg['model_type'] = 'clip_only_hd'  # Use HD-enhanced clip-only model
...
cfg['use_unified_hd_validation'] = False  # Use original GMMFormer HD validation
cfg['use_binary_inference'] = True        # Use binary HD for inference
