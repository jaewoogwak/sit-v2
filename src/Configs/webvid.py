...
cfg['dataset_name'] = 'webvid'
cfg['seed'] = 9527
cfg['root'] = '/dev/ssd1/gjw/GMMFormer'
cfg['data_root'] = '/dev/hdd2/'

# Path to raw WebVid shards (.pt) used by the converter script
cfg['webvid_output_dir'] = '/dev/hdd2/webvid/output'

# We will convert PT shards to HDF5 in the following layout under data_root/webvid
...
cfg['visual_feature'] = 'clip'  # WebVid uses CLIP features in our conversion
cfg['visual_feat_dim'] = 512  # CLIP ViT-B/32 feature dimension
cfg['collection'] = 'webvid'
cfg['map_size'] = 32
...
cfg['max_desc_l'] = 30
cfg['max_ctx_l'] = 128
cfg['q_feat_size'] = 512  # CLIP text feature size
